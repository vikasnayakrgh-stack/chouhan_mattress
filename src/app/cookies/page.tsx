/**
 * Chouhan Mattress - Cookie Policy Page (/cookies)
 */
        ...
        <section className="bg-[#0F172A] text-white py-14 px-4 text-center border-b border-amber-500/20">
          <div className="container mx-auto max-w-3xl">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-300 text-xs font-bold uppercase tracking-wider mb-4">
              <CookieIcon className="w-4 h-4 text-amber-400" /> Cookie Usage
            </span>
            <h1 className="text-3xl sm:text-4xl font-black mb-2 font-heading">Cookie Policy</h1>
            <p className="text-slate-300 text-xs sm:text-sm">How we use cookies to deliver secure authentication and seamless shopping</p>
          </div>
        </section>
        ...
        <section className="py-12 px-4">
          <div className="container mx-auto max-w-3xl space-y-6 text-slate-700 text-sm">
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
              ...
              <p className="text-xs sm:text-sm text-slate-600">Essential HTTP-Only cookies (`sb-access-token`) are required to keep you securely logged in to your account and preserve your shopping cart state across browser sessions.</p>
            </div>

            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
              <h3 className="font-bold text-slate-900 text-base mb-2">2. Analytics & Performance</h3>
              <p className="text-xs sm:text-sm text-slate-600">We use anonymous analytical cookies to measure page load speeds and improve site navigation without storing personal identity details.</p>
            </div>
          </div>
        </section>
      </main>
