-- Chouhan Mattress — Admin Panel V1 schema (FIXED: added missing category_status & collection_status enums)
...
do $$ begin
  create type collection_status as enum ('active','inactive');
exception when duplicate_object then null; end $$;
